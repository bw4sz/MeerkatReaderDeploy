...
#from shell, starting from docker container here: https://hub.docker.com/r/bw4sz/cloudml/
...
cd ~
git clone https://github.com/bw4sz/MeerkatReaderDeploy.git

cd MeerkatReaderDeploy
...
declare VERSION_NAME=v4  # for example
...
sed "s|C:/Users/Ben/Dropbox/MeerkatReader/Output/|${BUCKET}/TrainingData/|g" Build/testing_data.csv  > Build/testing_dataGCS.csv
sed "s|C:/Users/Ben/Dropbox/MeerkatReader/Output/|${BUCKET}/TrainingData/|g" Build/training_data.csv > Build/training_dataGCS.csv

#upload needed documents for analysis
#upload from MeerkatReader
gsutil cp Build/dict.txt $BUCKET/TrainingData/
gsutil cp Build/testing_dataGCS.csv $BUCKET/TrainingData/
gsutil cp Build/training_dataGCS.csv $BUCKET/TrainingData/
